...
import org.bits_waves.waves2017.Adapters.Drama_adapter;
import org.bits_waves.waves2017.Adapters.Specials_adapter;
...
public class Specials extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Specials_adapter(listItems,getApplicationContext());
