...
public class TodaysFixturesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myFragmentView=inflater.inflate(R.layout.activity_todays_fixtures_fragment, container, false);
        ...
        for (int i = 0; i <= 10; i++) {
            EventItem listItem = new EventItem("Heading " + (i+1),
